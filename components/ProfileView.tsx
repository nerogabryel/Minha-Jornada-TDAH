        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {badges.map((badge) => {
            ...
            return (
              <div 
                key={badge.id} 
                className={`p-5 rounded-2xl border-2 border-b-4 flex items-center gap-5 transition-all duration-300 ${
                  isUnlocked 
              ...
              >
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border-2 border-black/5 ${
                  isUnlocked ? badge.color : 'bg-[rgb(var(--color-swan))] text-[rgb(var(--color-hare))]'
                }`}>
